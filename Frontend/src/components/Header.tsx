...
const Header = () => {
  ...
  return (
    <Navbar className="border-b-4 dark:border-neutral-800 [box-shadow:0_1px_18px_-5px_rgba(0,0,0,0.41)] dark:bg-[rgb(20,19,31)] dark:bg-[linear-gradient(90deg,_rgba(60,69,61,0.5)_0%,_rgba(41,47,55,1)_37%,_rgba(60,63,67,0.5)_100%)]">
      <Link
        to={"/"}
